...
def p_Instrucao3(t): "Instrucao : Cond"                         ; t[0] = t[1]
def p_Instrucao4(t): "Instrucao : ':' Funcao ';'"               ; t[0] = t[2]
#def p_Instrucao5(t): "Instrucao : Ciclo"                        ; t[0] = t[1]
...
def p_Print3(t): "Print : '.' '\"' STRING '\"'"                     ; t[0] = f'pushs {t[3]}'
...
#ciclos estao mal
def p_Ciclo1(t) : "Ciclo : Termoi Termoi DO '{' prog '}' LOOP"             ; t[0] = f'while{get_label_loop(t[3])}:\npushi {t[1]}\npushi {t[2]}\npushn 0\nsup\njz endwhile{get_label_loop(t[4])}\n{t[5]}\n pushg 0\npushi 1\nadd\nstoreg 0\njump while{get_label_loop(t[4])}\nendwhile{get_label_loop(t[4])}:'
def p_Ciclo2(t) : "Ciclo : Termoi Termoi DO Instrucao LOOP"                ; t[0] = f'while{get_label_loop(t[3])}:\npushi {t[1]}\npushi {t[2]}\npushn 0\nsup\njz endwhile{get_label_loop(t[4])}\n{t[4]}\n pushg 0\npushi 1\nadd\nstoreg 0\njump while{get_label_loop(t[4])}\nendwhile{get_label_loop(t[4])}:'
